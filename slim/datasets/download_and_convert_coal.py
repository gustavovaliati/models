...
# ==============================================================================
r"""Downloads and converts coal data to TFRecords of TF-Example protos.

This module downloads the coal data, uncompresses it, reads the files
that make up the coal data and creates two TFRecord datasets: one for train
